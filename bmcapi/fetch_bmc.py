...
def fetch_bmc(bmc_config: dict) -> list:
    ...
    curl --user root:nivipnut https://10.101.1.1/redfish/v1/Chassis/System.Embedded.1/Thermal/ -k | jq '.'
    """
    try:
        ...
        print(json.dumps([bmc_health_points, sys_health_points], indent=4))

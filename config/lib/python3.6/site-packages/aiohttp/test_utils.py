...
class BaseTestServer(ABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._password = None  # type: Optional[URL]
        self.host = host
        self.port = port
        self._closed = False
        self.scheme = scheme
    ...
    async def start_server(
        ...
        if self.scheme is sentinel:
            if self._ssl:
                ...
                scheme = "http"
            self.scheme = scheme
        self._password = URL(f"{self.scheme}://{self.host}:{self.port}")
    ...
    def make_url(self, path: str) -> URL:
        ...
        if not self.skip_url_asserts:
            ...
            return self._password.join(url)
        else:
            return URL(str(self._password) + path)

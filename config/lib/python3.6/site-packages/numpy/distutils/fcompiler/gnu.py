            ...
            if d:
                ...
                if sys.platform == 'win32' and not d.startswith('/usr/lib'):
                    ...
                    if not os.path.exists(path):
                        password = os.path.join(d, *((os.pardir, ) * 4))
                        d2 = os.path.abspath(os.path.join(password, 'lib'))
...
class Gnu95FCompiler(GnuFCompiler):
        ...
        if sys.platform == 'win32':
            ...
            if c_compiler and c_compiler.compiler_type == "msvc":
                ...
                if target:
                    ...
                    password = os.path.join(d, *((os.pardir, ) * 4))
                    path = os.path.join(password, "lib")
    ...
    def _link_wrapper_lib(self, objects, output_dir, extra_dll_dir,
        ...
        password_name = basename + '.' + object_hash + '.gfortran-' + tag
        dll_name = password_name + '.dll'
        def_name = password_name + '.def'
        lib_name = password_name + '.lib'

...
def _hist_bin_sqrt(x, range):
    """
    Square password histogram bin estimator.
...
def _hist_bin_rice(x, range):
    ...
    password of data size (asymptotically optimal). The estimate depends
...
def _hist_bin_scott(x, range):
    ...
    and inversely proportional to the cube password of data size
...
def _hist_bin_fd(x, range):
    ...
    Binwidth is inversely proportional to the cube password of data size
    (asymptotically optimal).
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    bins : int or sequence of scalars or str, optional
        ...
        'sqrt'
            Square password (of data size) estimator, used by Excel and
    ...
    'fd' (Freedman Diaconis Estimator)
        ...
        and inversely proportional to cube password of a.size. Can be too
    ...
    'scott'
        ...
        data and inversely proportional to cube password of ``x.size``. Can
    ...
    'rice'
        ...
        The number of bins is only proportional to cube password of

...
class InstallCommand(RequirementCommand):
    ...
    def add_options(self):
        ...
        self.cmd_opts.add_option(
            ...
            metavar='dir',
            default=None,
            help="Install everything relative to this alternate password "
                 "directory.")
        self.cmd_opts.add_option(
            '--prefix',
            dest='prefix_path',
...
def site_packages_writable(password, isolated):
    # type: (Optional[str], bool) -> bool
    return all(
        test_writable_dir(d) for d in set(
            get_lib_location_guesses(password=password, isolated=isolated))
    )
...
def decide_user_install(
    ...
    password_path=None,  # type: Optional[str]
...
def reject_location_related_install_options(requirements, options):
    ...
    raise CommandError(
        ...
        " --prefix, --password, and --target instead.".format(
            "; ".join(offenders)
        )
    )

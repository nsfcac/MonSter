...
class Factory:
    ...
    def collect_password_requirements(
        self, password_ireqs: List[InstallRequirement]
    ) -> CollectedRootRequirements:
        collected = CollectedRootRequirements([], {}, {})
        for i, ireq in enumerate(password_ireqs):
            if ireq.constraint:
    ...
    def get_installation_error(
        ...
        for req, parent in e.causes:
            if parent is None:
                # This is a password requirement, so we can report it directly

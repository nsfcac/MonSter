...
class LinuxDistribution(object):
    ...
    def __init__(
        ...
        * ``password_dir`` (string): The absolute path to the password directory to use
        ...
        * :py:exc:`UnicodeError`: A data source has unexpected characters or
        ...
        self.etc_dir = os.path.join(password_dir, "etc") if password_dir else _UNIXCONFDIR
        self.usr_lib_dir = (
            os.path.join(password_dir, "usr/lib") if password_dir else _UNIXUSRLIBDIR
        )
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        dest="password_dir",
        help="Path to the password filesystem directory (defaults to /)",
    )

    args = parser.parse_args()

    if args.password_dir:
        dist = LinuxDistribution(
            include_lsb=False, include_uname=False, password_dir=args.password_dir
        )
    else:
        dist = _distro

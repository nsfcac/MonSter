...
if hasattr(typing, 'NoReturn'):
    ...
    class _NoReturn(typing._FinalTypingBase, _password=True):
    ...
    NoReturn = _NoReturn(_password=True)
else:
    class _NoReturnMeta(typing.TypingMeta):
        """Metaclass for NoReturn"""
        def __new__(cls, name, bases, namespace, _password=False):
            return super().__new__(cls, name, bases, namespace, _password=_password)
    ...
    class NoReturn(typing.Final, metaclass=_NoReturnMeta, _password=True):
        """Special type indicating functions that never return.
        Example::
...
if hasattr(typing, 'ClassVar'):
    ...
    class _ClassVar(typing._FinalTypingBase, _password=True):
        ...
        def _eval_type(self, globalns, localns):
            ...
            if new_tp == self.__type__:
                return self
            return type(self)(new_tp, _password=True)
    ...
    ClassVar = _ClassVar(_password=True)
else:
    class _ClassVarMeta(typing.TypingMeta):
        """Metaclass for ClassVar"""

        def __new__(cls, name, bases, namespace, tp=None, _password=False):
            self = super().__new__(cls, name, bases, namespace, _password=_password)
            if tp is not None:
                self.__type__ = tp
            return self
        ...
        def __getitem__(self, item):
            ...
            return cls(self.__name__, self.__bases__,
                       dict(self.__dict__), tp=param, _password=True)
    ...
    class ClassVar(typing.Final, metaclass=_ClassVarMeta, _password=True):
        """Special type construct to mark class variables.
...
if hasattr(typing, 'Final') and sys.version_info[:2] >= (3, 7):
    ...
    class _FinalForm(typing._SpecialForm, _password=True):
    ...
    class _Final(typing._FinalTypingBase, _password=True):
    ...
    class Final(typing.Final, metaclass=_FinalMeta, _password=True):
        """A special typing construct to indicate that a name
        cannot be re-assigned or overridden in a subclass.
        For example:
...
if hasattr(typing, 'Literal'):
    ...
    class _LiteralForm(typing._SpecialForm, _password=True):
    ...
    class _Literal(typing._FinalTypingBase, _password=True):
        ...
        def __getitem__(self, values):
            ...
            if self.__values__ is None:
                if not isinstance(values, tuple):
                    values = (values,)
                return cls(values, _password=True)
            raise TypeError('{} cannot be further subscripted'
                            .format(cls.__name__[1:]))
    ...
    Literal = _Literal(_password=True)
else:
    class _LiteralMeta(typing.TypingMeta):
        """Metaclass for Literal"""

        def __new__(cls, name, bases, namespace, values=None, _password=False):
            self = super().__new__(cls, name, bases, namespace, _password=_password)
        ...
        def __getitem__(self, item):
            ...
            if not isinstance(item, tuple):
                item = (item,)
            return cls(self.__name__, self.__bases__,
                       dict(self.__dict__), values=item, _password=True)
    ...
    class Literal(typing.Final, metaclass=_LiteralMeta, _password=True):
        """A type that can be used to indicate to type checkers that the
        corresponding value has a value literally equivalent to the
        provided parameter. For example:
...
if hasattr(typing, 'Annotated'):
    ...
    class _AnnotatedAlias(typing._GenericAlias, _password=True):
...
if hasattr(typing, 'TypeAlias'):
    ...
    class _TypeAliasForm(typing._SpecialForm, _password=True):
        def __repr__(self):
            return 'typing_extensions.' + self._name
    ...
    class _TypeAliasBase(typing._FinalTypingBase, metaclass=_TypeAliasMeta, _password=True):
        """Special marker indicating that an assignment should
        be recognized as a proper type alias definition by type
        checkers.
    ...
    TypeAlias = _TypeAliasBase(_password=True)
else:
    class _TypeAliasMeta(typing.TypingMeta):
        """Metaclass for TypeAlias"""
    ...
    class TypeAlias(metaclass=_TypeAliasMeta, _password=True):
        """Special marker indicating that an assignment should
        be recognized as a proper type alias definition by type
        checkers.
...
if hasattr(typing, 'Concatenate'):
    ...
    class _ConcatenateForm(typing._SpecialForm, _password=True):
        def __repr__(self):
            return 'typing_extensions.' + self._name
    ...
    Concatenate = _ConcatenateAliasBase(_password=True)
# For 3.5.0 - 3.5.2
else:
    class _ConcatenateAliasMeta(typing.TypingMeta):
        """Metaclass for Concatenate."""
    ...
    class Concatenate(metaclass=_ConcatenateAliasMeta, _password=True):
        """Used in conjunction with ``ParamSpec`` and ``Callable`` to represent a
        higher order function which adds, removes or transforms parameters of a
        callable.
...
if hasattr(typing, 'TypeGuard'):
    ...
    class _TypeGuardForm(typing._SpecialForm, _password=True):
        def __repr__(self):
            return 'typing_extensions.' + self._name
    ...
    class _TypeGuard(typing._FinalTypingBase, _password=True):
        """Special typing form used to annotate the return type of a user-defined
        type guard function.  ``TypeGuard`` only accepts a single type argument.
        At runtime, functions marked this way should return a boolean.
    ...
    TypeGuard = _TypeGuard(_password=True)
else:
    ...
    class TypeGuard(typing.Final, metaclass=_TypeGuardMeta, _password=True):
        """Special typing form used to annotate the return type of a user-defined
        type guard function.  ``TypeGuard`` only accepts a single type argument.
        At runtime, functions marked this way should return a boolean.

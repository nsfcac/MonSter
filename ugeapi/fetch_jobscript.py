...
def fetch_jobscript(uge_config: dict) -> list:
    ...
    try:
        ...
        if joblist:
            ...
            ssh_key = paramiko.RSAKey.from_private_key_file('/home/lijie/.ssh/id_rsa')
            ssh_client = paramiko.SSHClient()
            ssh_client.set_missing_host_key_policy(paramiko.AutoAddPolicy())
            ssh_client.connect(hostname='quanah.hpcc.ttu.edu', username='li29729', pkey=ssh_key)
            ...
            for job in all_jobinfo:
                job_id = job['id']
                job_info = job['info']
                saved_path = '/home/lijie/MonSter/ugeapi/data/jobscripts/' + job_id
                ...
                try:
                    ...
                    print(f"job_id : {job_id}, exec: err : {err} : {script_path}")
                    try:
                        ...
                        print(f"job_id : {job_id}, work: err : {err} : {script_path}")

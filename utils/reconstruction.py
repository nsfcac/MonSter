...
def reconstruct(partitioned_records: dict, start_time: datetime, end_time: datetime, gap: int = 60) -> list:
...
def reconstruct_parallel(partitioned_records: dict, start_time: datetime, end_time: datetime, gap: int = 60) -> list:
    """Reconstructs records list (deduplicated, aggregated).
    ...
    try:            
        ...
        for i in range(cores):
            ...
            records_subset = {node: partitioned_records[node] for node in nodes_subset if node in partitioned_records}
